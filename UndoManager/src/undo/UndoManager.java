...
public interface UndoManager {
	...
	/**
	 * Returns <code>true</code> if there is currently a change that can be
	 * undone, and <code>false</code> otherwise.
	 */
	...
	/**
	 * Returns <code>true</code> if there is currently a change that can be
	 * redone, and <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @throws IllegalStateException
	 *             If the manager is in a state that does not allow an redo
	 *             (that is if either {@link #canRedo()} would have returned
	 *             <code>false</code>, or the application of the change failed).
	 */
	public void redo();
